...
Partial Class frmMovie
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "THE DARK KNIGHT"
        '
        'Label3
        '
        ...
        Me.Label8.Text = "CHILDREN OF HEAVEN"
        '
        'Label9
        '
